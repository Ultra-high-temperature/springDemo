...
public class CommentService {
    ...
    public void insert(Comment comment) {
        ...
        if (comment.getType() == CommentTypeEnum.COMMENT.getType()) {
            ...
            createNotify(comment, db_comment.getCommentator(), NotificationTypeEnum.REPLAY_COMMENT);
            //创建通知
        } else {
            //回复问题
            ...
            createNotify(comment,db_question.getCreator(), NotificationTypeEnum.REPLAY_QUESTION);
        }
    }

    private void createNotify(Comment comment, int receiver, NotificationTypeEnum replayType) {
